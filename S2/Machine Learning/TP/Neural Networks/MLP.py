...
from sklearn.model_selection import train_test_split
X_trainNN, X_testNN, y_trainNN, y_test = train_test_split(X, y, test_size=0.3, random_state=100)
...
from sklearn.neural_network import MLPClassifier
mlp = MLPClassifier(hidden_layer_sizes=(128, 64,), batch_size=64, solver="adam", activation="relu", max_iter=1000)
...
from sklearn.neural_network import MLPClassifier
mlp= MLPClassifier(hidden_layer_sizes=(100, 100,), batch_size=128, solver="lbfgs", alpha=0.1, activation="logistic", max_iter=10000, random_state=42)
mlp.fit(X_trainNN, y_train)
'''