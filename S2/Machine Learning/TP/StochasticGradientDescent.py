...
sgd_cls = SGDClassifier(loss="log", alpha=0.01, penalty="l1", random_state=42)

#train the classifier
sgd_cls.fit(x_train, y_train)

#predict the value of x_treain
predicted = sgd_cls.predict(x_test)

#Classification report
print("Classifier : ", sgd_cls)
print("Classification report for classifier %s:\n%s\n", metrics.classification_report(y_test, predicted))

disp = metrics.plot_confusion_matrix(sgd_cls, x_test, y_test)
disp.figure.savefig('Confusion Matrix')
